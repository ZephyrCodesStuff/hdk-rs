...
mod tests {
    ...
    fn unpack_sharc() {
        ...
        let mut archive = crate::sharc::reader::SharcArchive::open(cursor, DEFAULT_KEY).unwrap();
    ...
    fn unpack_repack_unpack_sharc() {
        ...
        let mut new_archive =
            crate::sharc::reader::SharcArchive::open(cursor, DEFAULT_KEY).unwrap();
    ...
    fn roundtrip_write_read() {
        ...
        let archive = crate::sharc::reader::SharcArchive::open(cursor, DEFAULT_KEY).unwrap();
